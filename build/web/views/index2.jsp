<%-- 
    Document   : index2
    Created on : Jul 19, 2019, 6:48:16 AM
    Author     : Natasha
--%>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="background-image: url(views/img/bg/2.jpg);">
                        <div class="carousel-caption text-center">
                            <h1>HELLO, <% out.print(session.getAttribute("name").toString().toUpperCase()); %></h1>
                            <a href="category" class="btn btn-outline-light btn-lg">Borrow Now!</a>
                        </div>
                    </div>
