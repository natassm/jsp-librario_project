<%-- 
    Document   : adminPublisher
    Created on : Jul 19, 2019, 10:31:07 AM
    Author     : Natasha
--%>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
          <%
            ...
            ResultSet rs = bc.get3(con);
            %>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="mt-5 mb-5">Publisher</h3>
                    <table class="table table-bordered pb-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><% out.println(rs.getString("publisherName"));%></td>
                            </tr>
                            <% } %>
                        </tbody>
                    </table>
